...
def file_recon():
    body = ("STP received successfully (1):\n"
            ...
            "7382934, 'ordenante': 'BANCO', 'cuenta_ordenante': '646137827000"
            "027384', 'rfc_curp_ordenante': 'ND', 'beneficiario': 'Carlos Gon"
            "zalez', 'cuenta_beneficiario': '072696273648711499', 'rfc_curp_b"
